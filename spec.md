...
**Why students count toward the total but aren't shown the badge**: a live test window is the heaviest sustained load this app ever sees, so omitting students would make the count least accurate precisely when it matters most. They don't get the badge for the same reason they don't get the jobs badge — it's a coordination tool for people who can start heavy work, and a student can't. (The header isn't rendered on the test-taking page at all.)
