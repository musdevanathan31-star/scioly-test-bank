...
- **✓ Validate answer** (per question) or **✓ Validate page** (everything on the current page) — sends the question to Haiku and stores a verdict + rationale. Lives in the card's collapsed **Review** section along with the manual verdict dropdown (below).
